...
public class InsertMem {
	...
	public int insertMember(Connection conn, User user) throws SQLException {
		int rs = 0;
		String sql = "insert into members(userid, userpass, username, useremail, usertel, usepost, useraddr1, useraddr2, useraddrexc) values (?,?,?,?,?,?,?,?,?)";
		try {
